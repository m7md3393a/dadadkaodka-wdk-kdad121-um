...
client.login("NzQ5MjI5Mzc1ODI3ODY5NzQ2.X0o8Ow.AUOIWgjgUzlpRToX_fMeTOwar28");
...
client.on("message", message => {
  ...
  fetch(link).then(() => {
    ...
    message.reply("Done uptimed your Project now 24/7 <a:563109620462256170:749428364900564992> ");
